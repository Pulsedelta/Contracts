...
contract FullMarketFlowTest is TestHelpers {
    ...
    function test_FullMarketLifecycle() public {
        ...
        CategoricalMarket(market).buyShares(1, 0, 3000 * 1e18);
        vm.stopPrank();
    ...
    function test_MultipleMarketsFlow() public {
        ...
        for (uint256 i = 0; i < 3; i++) {
            ...
            CategoricalMarket(currentMarket).buyShares(0, 0, 1000 * 1e18);
            vm.stopPrank();
        }
    ...
    function test_HighVolumeTrading() public {
        ...
        for (uint256 i = 0; i < 50; i++) {
            ...
            CategoricalMarket(market).buyShares(outcome, 0, 100 * 1e18);
            vm.stopPrank();
        }
    ...
    function test_PriceDiscovery() public {
        ...
        vm.startPrank(alice);
        collateral.approve(market, 50_000 * 1e18);
        CategoricalMarket(market).buyShares(0, 0, 50_000 * 1e18);
        vm.stopPrank();
    ...
    function test_MarketStateConsistency() public {
        ...
        CategoricalMarket(market).buyShares(0, 0, 3_000 * 1e18);
